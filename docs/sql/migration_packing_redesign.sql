...
--
-- If you only need the new tables (no legacy packing tables to drop), or you
-- get "Table 'packing_session' doesn't exist", run instead:
--   docs/sql/create_packing_tables_if_not_exists.sql
-- ============================================================
