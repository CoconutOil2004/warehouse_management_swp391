            ...
            <t:layout title="Update Customer">
                ...
                <jsp:body>
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <form method="POST" action="${pageContext.request.contextPath}/admin/customer/update" class="m-0">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            value="${customer.email}" placeholder="contact@customer.com" required>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="address" name="address" rows="2"
                                        placeholder="Customer Address" maxlength="255">${customer.address}</textarea>
                                </div>
